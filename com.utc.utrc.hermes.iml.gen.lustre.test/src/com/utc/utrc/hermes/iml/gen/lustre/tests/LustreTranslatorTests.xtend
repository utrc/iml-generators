...
class LustreTranslatorTests {
	...
	@Test
	def void testFilter() {
		val sys = new Systems(systemServices, qnp)
...
"
		var expectedOutputNoWhitespace =  expectedOutput.replaceAll("\\s+","");
		var acturalOutputNoWhitespace =  output.replaceAll("\\s+","");
		assertTrue(expectedOutputNoWhitespace.equalsIgnoreCase(acturalOutputNoWhitespace))
	}
